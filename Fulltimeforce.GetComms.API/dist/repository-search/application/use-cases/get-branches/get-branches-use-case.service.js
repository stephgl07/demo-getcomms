...
let GetBranchesUseCase = class GetBranchesUseCase {
    ...
    async execute(repoName, page, per_page) {
        const branches = await this.apiGateway.getBranches(repoName, page, per_page);
...
exports.GetBranchesUseCase = GetBranchesUseCase = __decorate([
    ...
    __param(0, (0, common_1.Inject)(branches_service_1.BranchesService)),
    __metadata("design:paramtypes", [Object])
], GetBranchesUseCase);
//# sourceMappingURL=get-branches-use-case.service.js.map